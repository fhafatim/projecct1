...
<div style="padding-bottom: 10px; margin-left: 10px">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
      <?php foreach ($bidang as $t) : ?>
        <a class="dropdown-item" href="<?= base_url('admin/laporan_sudah_legal/filter3/' . $t->id_bidang); ?>"><?= $t->bidang?></a>
      <?php endforeach; ?>
    </div>
   <br/>
   <br/>
        ...
        <?php 
         ...
         foreach($barang as $brg) : ?>
            ...
            <td><?php echo $brg->nama_usaha?></td>
                ...
                <td><?php echo anchor(base_url('admin/laporan_sudah_legal/terima/'.$brg->id_pengajuan), '<div class="btn btn-sm btn-primary">Terima</div>') ?>
                    <?php echo anchor(base_url('admin/laporan_sudah_legal/tolak/'.$brg->id_pengajuan), '<div class="btn btn-sm btn-primary">Tolak</div>') ?>
                </td>
                <td>
        <?php  echo anchor(base_url('admin/laporan_sudah_legal/hapus/'.$brg->id_pengajuan), '<div class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></div>', 'onclick="javasciprt: return confirm(\'Anda Yakin Hapus ?\')"'); ?> </td>
        	</tr>
        </tr>
    <?php endforeach; ?>
</table>
